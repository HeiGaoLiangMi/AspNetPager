        ...
        private void CreateNavigationButton(HtmlTextWriter writer, NavigationButton btn)
        {
            ...
            */
            if (PagingButtonLayoutType != PagingButtonLayoutType.None) //add css class and style attribute to pager item directly
            {
                switch (btn)
                {
                    case NavigationButton.First: //first page button
                        AddClassAndStyle(FirstButtonsClass, FirstButtonsStyle, writer);
                        break;
                    case NavigationButton.Last: // last page button
                        AddClassAndStyle(LastButtonsClass, LastButtonsStyle, writer);
                        break;
                    case NavigationButton.Prev: // prev page button
                        AddClassAndStyle(PrevButtonsClass, PrevButtonsStyle, writer);
                        break;
                    case NavigationButton.Next: // next page button
                        AddClassAndStyle(NextButtonsClass, NextButtonsStyle, writer);
                        break;
                }
            }
